function displayTitle(font, ctx) {
...
function displayMusic(font, ctx, status) {
...
function displayControls(font, ctx) {
...
function displayStartBtn(font, ctx) {
...
export function createGameSettingsWindow(font, audioSettingd) {
