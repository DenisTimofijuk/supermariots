...
export function createLabelsLayer(font: FontClass) {
    ...
    function setTiles(tiles: Matrix, label: string, startX: number, y: number) {
        let x = startX;
    ...
    return function drawGameOver(context: CanvasRenderingContext2D, camera: Camera) {
